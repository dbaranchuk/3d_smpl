...
CUDA_VISIBLE_DEVICES=0 python main.py --name=model_from_scratch --is_train=True --learning_rate=0.000001  --batch_size=64 --gf_dim=32 --is_sup_train=True --max_iter=2000
