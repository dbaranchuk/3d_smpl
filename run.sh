# pretrain
#CUDA_VISIBLE_DEVICES=0 nohup python main.py --name=pretrain_b32_gf32_lr4_10k_2 --learning_rate=0.0001  --batch_size=32 --is_train=True --gf_dim=32 --is_sup_train=True --max_iter=10000
