...
flags.DEFINE_float("chamfer_scale", 0.5, "size of chamfer image. Reduce to save memory and computation")
...
flags.DEFINE_boolean("is_dryrun", True, "Run one batch to see whether visibility is correct"
