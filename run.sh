...
# Predict 1
CUDA_VISIBLE_DEVICES=0 python main.py --name=pretrain_b32_gf32_lr4_10k --model_dir=checkpoint/pretrain_b32_gf32_lr4_10k --is_train=False  --batch_size=1 --gf_dim=32 --is_sup_train=False
# Predict 2
