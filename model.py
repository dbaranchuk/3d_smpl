...
class _3DINN(object):
    ...
    def loadData(self):
        ...
        self.chamfer_sr_t, self.c_sr_t, self.f_sr_t, self.resize_scale_sr_t, self.gender_sr_t, self.J_c_sr_t, self.pmesh_sr_t, self.v_gt_t = self.centered_3d(*inputs_surreal(surreal_test_filenames, self.config.batch_size, shuffle=False, num_frames=138), 138)
