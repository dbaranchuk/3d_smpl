...
CUDA_VISIBLE_DEVICES=0 python main.py --name=model2 --batch_size=1 --model_dir=checkpoint/model2 --gf_dim=32 --is_sup_train=False --is_train=False #--key_loss=True #--silh_loss=True
