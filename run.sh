...
#finetune
CUDA_VISIBLE_DEVICES=0 python main.py --name=finetune --batch_size=4 --model_dir=checkpoint/model4 --gf_dim=32 --is_sup_train=False --is_train=True --key_loss=True --max_iter=1000 #--silh_loss=True --max_iter=1000
