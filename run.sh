...
# Predict
CUDA_VISIBLE_DEVICES=0 python main.py --name=finetune_lr6 --batch_size=1 --model_dir=checkpoint/pretrain_b32_gf32_lr4_10k --gf_dim=32 --is_sup_train=False --is_unsup_train=False --is_train=False --key_loss=True #--silh_loss=True
