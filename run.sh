# pretrain
CUDA_VISIBLE_DEVICES=0 python main.py --name=pretrain_b32_gf32_lr4_10k_3 --is_train=True --learning_rate=0.0001  --batch_size=32 --gf_dim=32 --is_sup_train=True --max_iter=15000
...
# Predict 1
CUDA_VISIBLE_DEVICES=0 python main.py --name=predict --model_dir=checkpoint/pretrain_b32_gf32_lr4_10k_3 --is_train=False  --batch_size=1 --gf_dim=32 --is_sup_train=False
# Predict 2
