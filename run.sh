...
#CUDA_VISIBLE_DEVICES=0 python main.py --name=model6 --model_dir=checkpoint/pretrain_b32_gf32_lr4_10k --is_train=True --learning_rate=0.00001  --batch_size=128 --gf_dim=32 --is_sup_train=True --max_iter=5000

#CUDA_VISIBLE_DEVICES=0 python main.py --name=model6 --model_dir=checkpoint/model6 --is_train=True --learning_rate=0.000001  --batch_size=64 --gf_dim=32 --is_sup_train=True --max_iter=1000
